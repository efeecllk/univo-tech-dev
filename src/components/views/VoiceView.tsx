        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="order-first lg:order-last -mx-4 px-4 lg:mx-0 lg:px-0">
                    <div className="flex flex-row flex-nowrap gap-4 overflow-x-auto pb-4 -mx-4 px-4 pt-4 mb-4 lg:mb-0 lg:pt-0 lg:px-0 lg:mx-0 lg:pb-0 lg:flex-col lg:overflow-x-visible lg:gap-8 lg:pr-2 snap-x snap-mandatory bg-[rgba(var(--primary-rgb),0.08)] lg:bg-transparent transition-colors duration-300" style={{ scrollbarWidth: 'thin' }}>
                        {/* Weekly Poll */}
